...
- **Households:** resident creator, seven life stages, caregiver lineage, inherited personality, relationships, aspirations, five branching career tracks, skills, needs, schedules, wages, daily expenses, household funds, and three discretionary purchases are live; inventories, milestones, household splits, and physically active careers remain ahead
...
- Add object ownership, personal inventories, outfits, life milestones, deeper recurring preferences, and household schedules.
...
- Expand those career branches into workplaces that physically exist in the city and create visible coworkers, customers, active tasks, and service demand.
- Add visitors, invitations, celebrations, childcare interactions, moving, and household splits while preserving social memory.
