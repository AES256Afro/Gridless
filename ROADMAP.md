...
Next systems are branching physical careers, personal inventories and object ownership, deeper catalog variants, visitors and household milestones, richer event and vehicle audio cues, and metropolitan streaming built on the current simulation level of detail.
