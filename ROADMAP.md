...
- Road drawing can snap exactly to existing network endpoints within 12 meters or lock each new segment to a 15-degree bearing. The live guide reports length, bearing, and joined road, while duplicate points, Backspace revision, and Escape cancellation keep freeform drafting recoverable.
...
Next systems are deeper recurring preferences, catalog variants, household schedules and splits, tangent and parallel road guides, road grade tools, direct business-profit feedback, richer event and vehicle audio cues, and metropolitan streaming built on the current simulation level of detail.
...
- [In progress] Exact endpoint snapping, optional 15-degree angle locking, live length and bearing feedback, duplicate protection, Backspace revision, and Escape cancellation are live without a tile grid; tangent and parallel guides remain ahead.
...
- Add deeper recurring preferences and household schedules.
...
- [In progress] Career branches now use physical city workplaces, named rosters, active attendance, track-specific tasks, performance history, visible coworker and customer agents, and live service pressure across all three scales; direct business-profit feedback remains ahead.
