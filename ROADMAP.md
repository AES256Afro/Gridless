...
Next systems are deeper recurring preferences, catalog variants, household schedules and splits, road snapping and grade tools, direct business-profit feedback, richer event and vehicle audio cues, and metropolitan streaming built on the current simulation level of detail.
