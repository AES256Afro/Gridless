...
Next systems are deeper recurring preferences, celebrations, catalog variants, visitors and household splits, road snapping and grade tools, direct business-profit feedback, richer event and vehicle audio cues, and metropolitan streaming built on the current simulation level of detail.
