...
- [Complete] Homes retain player-selected gable, hip, flat, or planted roof forms plus a custom roof color. Changes charge the design budget, unchanged designs cannot double-charge, older homes receive a city-specific default, and the authored silhouette is shared by Home Simulator, parcel evidence, and City Explorer.
- [Complete] Homes retain slab, ventilated crawlspace, or raised-pier foundations. Regional defaults reflect local building patterns, upgrades charge exact design costs, flood protection reduces residual exposure and long-term room wear, and the same foundation form and resilience evidence appears at home, parcel, and Explorer scales.
- [Complete] Home energy performance combines current regional temperature, floor area, roof form, foundation, authored window area and glazing, daylight, and occupancy into heating, cooling, lighting, daily kWh, daily cost, and a bounded efficiency score. The resulting utility cost settles into household finances and the contributing benefits remain visible while building or inspecting the parcel.
- [Complete] Residents can claim a bed-backed Bedroom, Nursery, or Studio. Claims are persistent, one room per resident, limited by physical bed capacity, safely reassigned or cleared, removed when residents move, and translated into private or shared-room privacy that contributes to home quality and remains visible in Home Simulator and parcel evidence.
...
- [Complete] A player can approve a ready home for move-in. Unsafe or capacity-blocked homes are refused, the approval time and score persist through saves and Undo, and authorization automatically suspends whenever the live readiness gate fails again.
- [Complete] Players can pin up to three move-in goals directly from the highest live readiness priorities. The goals persist, remain visible at home and parcel scales, and complete only when the corresponding simulated safety, space, organization, energy, privacy, or condition evidence is resolved.
- [Complete] An approved household can begin one persistent first night. Residents enter their claimed rooms, start activities from the actual furnishings, gain comfort and calm, record permanent homecoming milestones, and cannot repeat or bypass a suspended move-in approval.
...
- [Complete] Furniture placement previews show green or red footprints before a click, preserve and validate every footprint in a moving group, and report the active floor, exact catalog price, budget shortfall, or physical blocker in both the scene and build toolbar.
- [Complete] Drawing a room previews its complete footprint, dimensions, area, exact shell cost, and floor before the second click. The same validator rejects undersized, overlapping, out-of-parcel, unavailable-floor, and over-budget rooms during preview and commit.
...
- [Complete] Turn inspection history into an explainable trend with direction, signed score change, best score, and failed-to-passed recognition across home and parcel UI.
