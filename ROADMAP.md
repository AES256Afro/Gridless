...
Next systems are deeper recurring preferences, catalog variants, household splits, tangent and parallel road guides, road grade tools, richer event and vehicle audio cues, and metropolitan streaming built on the current simulation level of detail.
...
- [In progress] Five persistent resident rhythm profiles now drive weekday, weekend, work, school, outing, and sleep timing across all three scales; deeper recurring preferences remain ahead.
