...
- **Households:** resident creator, seven life stages, caregiver lineage, inherited personality, relationships, aspirations, five branching career tracks, physical workplaces and daily tasks, favorite styles and pastimes, bounded personal collections, object ownership, skills, needs, schedules, wages, daily expenses, household funds, and three discretionary purchases are live; outfits, milestones, visitors, customers, and household splits remain ahead
...
- The gate checks calendar and budget boundaries, resident needs, household and business cohorts, physical workplace references, task-track validity, work performance, commute references, service and utility state, incident backlogs, save growth, finite numbers, and bounded population change.
...
Next systems are visible coworkers and customers at active workplaces, outfits and life milestones, deeper catalog variants, visitors and household splits, road snapping and grade tools, richer event and vehicle audio cues, and metropolitan streaming built on the current simulation level of detail.
...
- Add outfits, life milestones, deeper recurring preferences, and household schedules.
...
- [In progress] Career branches now use physical city workplaces, named rosters, active attendance, track-specific tasks, and performance history across all three scales; visible coworker and customer agents plus direct service demand remain ahead.
