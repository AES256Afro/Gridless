...
Next systems are catalog variants, household splits, tangent and parallel road guides, road grade tools, richer event and vehicle audio cues, and metropolitan streaming built on the current simulation level of detail.
